...
public class RideCleansingExercise extends ExerciseBase {
	...
	private static class NYCFilter implements FilterFunction<TaxiRide> {
		...
		// Границы Нью-Йорка
		private static final float MIN_LON = -74.05f;
		private static final float MAX_LON = -73.75f;
		private static final float MIN_LAT = 40.65f;
		private static final float MAX_LAT = 40.95f;

		@Override
		public boolean filter(TaxiRide ride) {
			return isInNYC(ride.startLon, ride.startLat) &&
